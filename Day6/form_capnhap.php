<?php 
    ...
    $sql = "select * from phongban where id = '$mapb'" ;
...
<form name="form" action="xulicapnhap.php" method='post'>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="moTa" id="moTa" value = '<?php echo $row['moTa'];?>'>
            </div>
        </div>
